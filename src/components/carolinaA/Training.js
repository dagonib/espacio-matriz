                ...
                <Row xs={2} md={3} className='d-flex flex-column flex-sm-row align-items-center justify-content-sm-center'>
                    <Col className='logo_box d-flex flex-column justify-content-center align-items-center p-3'> 
                        <Image
                            ...
                            src={logo_hsk}
                        />
                        <p className="text-center mt-2 m-0">Curso introductorio a la Medicina Tradicional China y el Ciclo Menstrual</p>
                    </Col>
                    <Col className='logo_box d-flex flex-column justify-content-center align-items-center p-3'> 
                        <Image 
                            className='img_logo mt-3 mt-sm-0  my-2 my-sm-0 mx-sm-3'
                            src={logo_cooperacio}
                        />
                        <p className="text-center mt-2 m-0">Escola Popular d'Ecnonmia Feminista</p>
                    </Col>
                    ...
                    <Col className='logo_box d-flex flex-column justify-content-center align-items-center p-3'> 
                        <Image 
                            ...
                            src={logo_anthemon}
                        />
                        <p className="text-center mt-2 m-0">Viaje a la Mujer Consciente</p>
                    </Col>
                    ...
                    <Col className='logo_box d-flex flex-column justify-content-center align-items-center p-3'> 
                        <Image 
                            ...
                            src={logo_casaluna}
                        />
                        <p className="text-center mt-2 m-0">Terapeuta Menstrual</p>
                    </Col>
                    ...
                    <Col className='logo_box d-flex flex-column justify-content-center align-items-center p-3'> 
                        <Image 
                            ...
                            src={logo_gremi}
                        />
                        <p className="text-center mt-2 m-0">Herbodietética</p>
                    </Col>

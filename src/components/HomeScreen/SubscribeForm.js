...
const SubscribeForm = () => {
    return (
        <Row className="bg-dark py-5 m-0">
            <Container>
                <Form className='d-flex flex-column justify-content-center flex-md-row'>
                    <Col md={4} className='subscribe-main-box mt-0 mt-md-1 p-0'>
                        <Form.Text className='subscribe-main-text text-white mr-3 m-0'>
                    ...
                    <Col md={8} className='p-0'>
                        <Row className='d-flex flex-nowrap flex-column flex-md-row justify-content-left m-0'>
                            <Form.Group className='w-100 mr-0 mt-3 mr-md-3 mt-md-0 m-0'>
                                <Form.Control type='text' placeholder='Tu nombre' name='nombre' className='subscribe-form-input'></Form.Control>
                            </Form.Group>
                            <Form.Group  className='w-100 mr-0 mt-3 mr-md-3 mt-md-0 m-0'>
                                <Form.Control type='email' placeholder='Tu email' name='nombre' className='subscribe-form-input'></Form.Control>
                            </Form.Group>
                        ...
                        <Row className='d-flex flex-column flex-md-row mt-3 m-0'>    
                            <Button variant='primary' type='submit'>
                                Me apunto
                            </Button>         
                            <Form.Group className='d-flex flex-row justify-content-center justify-content-md-left align-items-center mt-2 mt-md-0 ml-md-5 m-0'>
